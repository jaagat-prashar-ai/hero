...
def _run_on_gpu_node(cfg: dict[str, Any]) -> None:
    ...
    if reward_mode == "llm_judge":
        ...
        if judge_model != "mock":  # mock = zero-API infra smoke mode, no key at all
