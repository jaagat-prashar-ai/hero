...
ENTITY_TO_CLASSES: dict[str, frozenset[str] | None] = {
    ...
    "stopped_vehicle": frozenset({"automobile", "other_vehicle", "trailer", "bus", "heavy_truck"}),
    "cutin_vehicle": frozenset({"automobile", "other_vehicle", "trailer", "bus", "heavy_truck"}),
    "vehicle_generic": frozenset({"automobile", "other_vehicle", "trailer", "bus", "heavy_truck"}),
    "cross_traffic": frozenset({"automobile", "other_vehicle", "trailer", "rider", "bus", "heavy_truck"}),
    "oncoming_traffic": frozenset({"automobile", "other_vehicle", "trailer", "rider", "bus", "heavy_truck"}),
